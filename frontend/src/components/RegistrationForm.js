            ...
            <div className="columns">
                <div className="column">
                  ...
                  <i className='fas fa-check'></i>
                            ...
                            {register.errors.username && <small role={'help-text'} className="help is-danger">
                  ...
                  <i className="fas fa-id-card"></i>
                            ...
                            {register.errors.first_name && <small role={'help-text'} className="help is-danger">
                  ...
                  <i className="fas fa-id-card"></i>
                            ...
                            {register.errors.last_name && <small role={'help-text'} className="help is-danger">
                  ...
                  <i className='fas fa-exclamation-triangle'></i>
                            ...
                            {register.errors.email && <small role={'help-text'} className="help is-danger">
                    ...
                    <i className="fas fa-lock"></i>
                            ...
                            {register.errors.password && <small role={'help-text'} className="help is-danger">
                    ...
                    <i className="fas fa-lock"></i>
                            ...
                            {register.errors.password_confirmation && <small role={'help-text'} className="help is-danger">
